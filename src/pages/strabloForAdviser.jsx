...
const strabloForAdviser = () => {
    return (
        <div className='font-inter bg-[#fcfefe]'>
                ...
                <div className=' border-x-2 border-gray-100 lg:w-9/12 w-11/12 m-auto'>
                    <div className='py-12  text-center lg:w-9/12 w-11/12 border-x-2 border-gray-100 m-auto'>
                        ...
                        <div className='flex items-center sm:flex-row flex-col justify-center gap-2 mt-4'>
                            <input type="text" name="text" className='px-4 sm:w-5/12 w-9/12 focus:outline-none py-2 rounded-full h-14 text-sm border-2 border-gray-100' id="" placeholder='Enter your email Address' />
                            <p className='sm:w-3/12 w-6/12'>
            ...
            <div className='flex justify-between lg:flex-row flex-col w-10/12 gap-3 py-2 m-auto mt-16'>
                <div className='lg:w-6/12 w-11/12'>
                    <h1 className='m-auto  lg:text-4xl sm:text-2xl text-xl  lg:leading-[60px] font-semibold '>
                ...
                <div className='lg:w-6/12 w-11/12 '>
                    ...
                    <p className='lg:w-4/12 sm:w-7/12 w-11/12 mt-4'>
            ...
            <div className='text-center w-11/12 m-auto mt-20 border-x-2 border-gray-100'>
                <h1 className='m-auto lg:text-4xl sm:text-2xl text-xl  lg:leading-[60px] pt-4  py-4  font-semibold '>
            ...
            <div className='text-start w-11/12 m-auto mt-20 border-x-2 border-gray-100'>
                <h1 className='m-auto lg:text-4xl sm:text-2xl text-xl  lg:leading-[60px] mt-4  py-4 px-3 font-semibold '>
            ...
            <div className=' border-b-2 w-full border-gray-100 m-auto '>
                <div className='border-x-2 border-gray-100 w-11/12 m-auto'>
                    <div className='w-full m-auto text-center '>
                        <h1 className='m-auto lg:text-4xl sm:text-2xl text-xl   text-center pt-12 font-semibold '>
